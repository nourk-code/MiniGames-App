...
# // Function to process the frame and calculate iris-to-pupil ratio
# function processFrame(image) {
#       console.log('processFrame called');
#       let debugModeOn = false;

#       // Crop and resize the frame
#       image = cropToAspectRatio(image);

#       // Find the darkest point (likely the pupil)
#       let darkestPoint = getDarkestArea(image);
...
#       let [pupilRotatedRect] = processFrames(
...
#       // Calculate iris and pupil areas
#       let irisArea = Math.PI * (pupilRotatedRect.size.width / 2) * (pupilRotatedRect.size.height / 2);
#       let pupilArea = Math.PI * (pupilRotatedRect.size.width / 2) * (pupilRotatedRect.size.height / 2);

#       // Calculate iris-to-pupil ratio
#       let irisPupilRatio = irisArea / pupilArea;
#       console.log('Calculated iris-to-pupil ratio:', irisPupilRatio);

#       // Send the ratio back to React Native via WebView
